                                            ...
                                            <div class="p-20">
                                                <form action="{{route('signup-type-products')}}" method="post" class="form-horizontal" role="form">
                                                    ...
                                                    <div class="form-group row">            
                                                        ...
                                                        <div class="col-10">
                                                            <input type="text" class="form-control" name="category" placeholder="Thời Trang Nam, Thời Trang Nữ, Phụ Kiện Thời Trang,....." value="{{old('category')}}">
                                                        </div>
                                                    </div>                                                    
                                                    <div class="form-group row">
                                                        <label class="col-2 col-form-label">Loại Sản Phẩm</label>
                                                        <div class="col-10">
                                                            <input type="text" name="type_products" class="form-control" placeholder="Áo, Quần,....." value="{{old('type_products')}}">
                                                        </div>
                                                    </div>                                                    
